...
| `js/class-build-system.js` | 流派被动 + 装备 skillModifiers |
| `js/skill-entity-system.js` | 弹丸/召唤/场域实体 + 施法条 UI |
...
**v2.1 全覆盖（79 主动技能）**：
- **56 个实体技能**：弹丸 / 召唤 / 场域 / 瞬击 / 位移 / 冲撞
- **23 个 primary 技能**：战吼、冰甲、嘲讽、治疗波、处决阈值外的 Buff/护盾/标记等

合并命令：`python tools/merge_skill_entities.py`
...
- [x] 破防条 UI（血条下紫色护盾条）
- [x] 流派被动完整战斗逻辑（血魔 HP 上限、惩戒神圣能量等）
- [x] 装备 skillModifiers 运行时应用
- [x] deployment/ 与根目录同步
- [ ] 全 28 职业进化技能补全至 ~80 条
