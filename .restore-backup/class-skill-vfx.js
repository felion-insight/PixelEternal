...
(function () {
    ...
    window.playClassSkillVfx = function playClassSkillVfx(player, skillDef, gameInstance, context) {
        ...
        if (skillDef.entityType === 'instant' && (instantShape === 'cone' || ec.shape === 'cone' || instantShape === 'pierce' || ec.shape === 'pierce')) {
            ...
            const isAssassinBasic = (family === 'shadow_force' || family === 'shadow_dancer' || family === 'shadow_nightblade'
                || family === 'shadow_trickster' || family === 'shadow_illusionist' || family === 'shadow_venom' || family === 'shadow_plague')
                && skillDef.slotType === 'basic' && (context && context.comboChain > 1);
        ...
        const travelVariant = {
            ...
            focus: 'archer_shot',
            mana: 'mage_bolt',
            elemental_power: 'mage_bolt',
            chronos_sand: 'mage_bolt',
            soul_shard_v2: 'mage_bolt',
            energy: 'assassin_cut'
        }[family] || 'warrior_slash';

        const isMageFamily = family === 'mana' || family === 'elemental_power'
            || family === 'chronos_sand' || family === 'soul_shard_v2';
        addVfx(gameInstance, aimX, aimY, {
            variant: travelVariant,
            duration: family === 'focus' ? 320 : (isMageFamily ? 480 : 400),
            radius: isMageFamily ? 64 : 56,
            angle,
            family,
            ox: px,
            oy: py,
        ...
        addVfx(gameInstance, aimX, aimY, {
            variant: 'hit_spark',
            duration: 380,
            delayMs: family === 'focus' ? 240 : (isMageFamily ? 280 : 180),
            radius: 50,
            angle,
            family,
            ox: px,
