...
class MyHTTPRequestHandler(http.server.SimpleHTTPRequestHandler):
    """本地开发：对 pe-local-dev-server.js 注入标志，供游戏启用 F1 开发者模式。"""

    _LOCAL_DEV_JS = b"window.__PE_LOCAL_DEV_SERVER__=true;\n"
    ...
    def do_GET(self):
        ...
        if path_only == "/js/pe-local-dev-server.js":
            body = self._LOCAL_DEV_JS
